"""
Django settings for taste_42330 project.
...
WSGI_APPLICATION = 'taste_42330.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taste_42330 API",
    "DESCRIPTION": "API documentation for taste_42330 App",
    "VERSION": "v1",
}
